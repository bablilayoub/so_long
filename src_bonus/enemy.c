...
/*   Updated: 2023/12/26 23:21:22 by abablil          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void handle_spawn_enemy(t_data *game, int *i, int *temp, int *already_spawned)
{
    if (!*already_spawned)
        spawn_enemy(game, i, temp, already_spawned);
}
